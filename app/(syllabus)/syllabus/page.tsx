...
export default function Syllabus() {
  return (
    <Box ml={['none','20%']} fontFamily={'inder'} pt={['20','10','none']} pl={['5','28']} pr={['5','10']}  textAlign={'left'}>
        <Stack textAlign={'center'}  fontWeight={'bold'} >
            ...
            <Text >Duration: 13 Weeks</Text>
                ...
                <Box >
                    <Text textDecoration={'underline'} fontWeight={'bold'} mt="2">Course Description:</Text>
                    <Text >
                    ...
                    <Text textDecoration={'underline'} fontWeight={'bold'} mt='2'>Course Outline:</Text>
                    <List pl={'4'} color={'blue.500'}>
                        <ListItem fontWeight={'bold'}>1. HTML and CSS (Homework) </ListItem>
                        <List pl={'4'} color={'blue.500'} >
                            <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}} >
                                <Link
                                href={
                        ...
                        <ListItem fontWeight={'bold'}>2. Web 3.0 and Metaverse Theory </ListItem>
                        <List pl={'4'} color={'blue.500'}>
                            <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                <Link
                                href={
                            ...
                            <ListItem pl={'4'} _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                <Link
                                href={
                        ...
                        <ListItem fontWeight={'bold'}>3. Fundamentals of Typescript</ListItem>
                        <List  color={'blue.500'}>
                            <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                <Link
                                href={
                            ...
                            <ListItem mt={'4'} fontWeight={'medium'} >
                                Fundamentals of JavaScript and Node.js Quiz
                            </ListItem>
                            <ListItem mt={'2'} fontWeight={'medium'}>
                            ...
                            <ListItem mt={'2'} >
                                ...
                                <ListItem pt={'2'}  _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                <Link
                                    href={
                        ...
                        <ListItem mt={'2'} fontWeight={'bold'} className=" mt-4 font-medium">
                        4. Object-Oriented Programming with TypeScript
                        </ListItem>
                        <List pl={'4'} color={'blue.800'} >
                            <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                            <Link
                                href={
                        ...
                        <ListItem fontWeight={'bold'}>5. TypeScript for React</ListItem>
                        <List color={'blue.500'}>
                            <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                            <Link
                        ...
                        <List pl={'4'} color={'blue.500'}>
                            ...
                            <Text fontWeight={'bold'}>We will also cover these readings:</Text>
                            <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                <Link
            ...
            <Box className="text-left ">
                        <Text>
                            <Heading id="q2-c" textAlign={'center'}  fontWeight={'bold'} >
                            Quarter II (Core)
                            </Heading>
                            ...
                            <Text mt={'4'} fontWeight={'semibold'}>Duration: 13 Weeks</Text>
                        </Text>

                            <Text fontWeight={'bold'} textDecoration={'underline'} mt={'4'} >Course Description:</Text>
                            <Text>
                            ...
                            <Text fontWeight={'bold'} textDecoration={'underline'} mt={'2'}>Course Outline:</Text>
                            <List pl={'4'} >
                            <ListItem fontWeight={'bold'}>1. Next.js 13 Web Development </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                <Link
                            ...
                            <ListItem fontWeight={'bold'}>2.Next.js 13 using Chakra UI (Remote Zoom Class) </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                            ...
                            <ListItem fontWeight={'bold'}>3.UI/UX Design with Figma, TailwindCSS, and Chakra UI (Remote  Zoom Class) </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                            ...
                            <ListItem fontWeight={'bold'}>4.API Routes with Next.js (Remote Zoom Class) </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                            ...
                            <ListItem fontWeight={'bold'}>5.APIs with Next.js and tRPC (Remote Zoom Class) </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                            ...
                            <ListItem fontWeight={'bold'}>6.SQL and Prisma </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                            ...
                            <ListItem fontWeight={'bold'}>7.Next.js 13 using TailwindCSS (Remote Zoom Class)</ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                            ...
                            <ListItem fontWeight={'bold'}>8.AWS Application Composer (Remote Zoom Class) </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                            ...
                            <ListItem fontWeight={'bold'}>9.Multi-Cloud GraphQL Serverless API Development with Cloud Development Kit for Terraform (CDKTF) (Remote Zoom Class) </ListItem>
                            <List pl={'4'} color={'blue.500'}>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                    href={
                    ...
                    <Box >
                        <Text>
                            <Heading id="q3-c" fontWeight={'bold'}>
                            Quarter III (Core)
                            </Heading>
                            <Text fontWeight={'bold'}>
                                $-101: Dollar Making Bootcamp - Full-Stack Template and API Product Development
                            </Text>
                            <Text mt={'4'} fontWeight={'bold'}>Duration: 13 Weeks</Text>
                        </Text>

                            <Text mt={'4'} fontWeight={'bold'} textDecoration={'underline'}>Earn While You Learn Projects</Text>
                            <Text mt={'4'} fontWeight={'bold'} textDecoration={'underline'}><b>A.</b>Build Full-Stack Next.js 13 Jamstack Templates</Text>
                            ...
                            <Text mt={'4'} fontWeight={'bold'} textDecoration={'underline'}><b>B.</b>Build QraphQL APIs </Text>
                    ...
                    <Box >
                        <Text fontWeight={'bold'} mb={'4'}>
                            ...
                            <Text mt={'4'}>Duration: 13 Weeks</Text>
                        </Text>

                            <Text mt={'4'} fontWeight={'bold'} textDecoration={'underline'}>Course Description: </Text>
                            <Text mt={'4'}>
                                ...
                                <ListItem color={'blue.500'} _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                            ...
                            <Text mt={'4'} fontWeight={'bold'} textDecoration={'underline'}>Course Outline:  </Text>

                            <Text mt={'4'} fontWeight={'bold'}><b>1.</b>Blockchain and Metaverse Theory</Text>
                             <List pl={'4'} color={'blue.500'}>   
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                            ...
                            <Text mt={4} fontWeight={'bold'}><b>2.</b>Smart Contract Development in Solidity </Text>
                            <List pl={'4'} color={'blue.500'}>   
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                            ...
                            <Text mt={'4'} fontWeight={'bold'} ><b>3.</b>Dapp Development using Ethers.js and Next.js 13 </Text>
                            <List pl={'4'} color={'blue.500'}>   
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                            ...
                            <Text mt={'4'} fontWeight={'bold'}><b>4.</b>Tokennomics </Text>
                            <Text mt={'4'} fontWeight={'bold'}><b>5.</b>Blockchain Project: Create a Token and Launch ICO/IEO/IDO</Text>
                            <List pl="4">
                            ...
                            <List pl={'4'} color={'blue.500'}>   
                                ...
                                <Text fontWeight={'bold'}>and you will notice that blockchain projects absolutely dominate the list.</Text>
                                <ListItem  _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                                ...
                                <Text fontWeight={'bold'}>Also check these links for latest listings:</Text>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                        ...
                        <Text fontWeight={'bold'} mb="8">
                            ...
                            <Text mt={'4'} fontWeight={'bold'}><b>1.</b>Open Metaverse Web Development </Text>
                             <List pl="4" color={'blue.500'}>   
                                <Text mt={'4'} fontWeight={'bold'} textDecoration={'underline'}>Course Description: </Text>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                            ...
                            <Text mt={'4'} fontWeight={'bold'}><b>2.</b>Blender 3D asset Creation for the Metaverse (Remote Zoom Class) </Text>
                            <List pl="4">   
                                <Text mt={'4'}>
                        ...
                        <Text  fontWeight={'bold'} mb={'8'}>
                            ...
                            <Text mt={'4'} fontWeight={'bold'}><b>1.</b>Introduction to Machine Learning, Data Science, and AI </Text>
                             <List pl="4" >   
                                <ListItem color={'blue.500'} _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                             ...
                             <Text mt={'4'} fontWeight={'bold'}><b>2.</b>Building Next-Gen Intelligent Apps with OpenAI’s Powerful Models </Text>
                             <List pl="4">   
                                <Text> We will cover GPT-4, ChatGPT, etc. and Next.js 13</Text>
                                <ListItem color={'blue.500'} _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                             ...
                             <Text mt={'4'} fontWeight={'bold'}><b>3.</b>Python Crash Course  for TypeScript Developers</Text>
                             <List pl="4">   
                                <Text> We will cover GPT-4, ChatGPT, etc. and Next.js 13</Text>
                                <ListItem color={'blue.500'} _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                        ...
                        <Text>
                            ...
                            <Text mt={'4'} fontWeight={'bold'}><b>1.</b>Deep Learning with Tensorflow </Text>
                             <List pl="4">   
                                <ListItem color={'blue.500'} _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                             ...
                             <Text mt={'4'} fontWeight={'bold'}><b>2.</b>Machine Learning Engineering for Production (MLOps) using Terraform for CDK</Text>
                             <List pl="4" color={'blue.500'}>   
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                        ...
                        <Text fontWeight={'bold'} mb={'8'}>
                            ...
                            <Text mt={'4'} fontWeight={'bold'} textDecoration={'underline'}>Course Outline:  </Text>
                             ...
                             <List pl="4" color={'blue.500'}>   
                                ...
                                <Text ><b>2.</b>Alexa with Matter Protocol</Text>
                                <ListItem _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                    <Link
                        ...
                        <Text fontWeight={'bold'} mb={'8'}>
                            ...
                            <b>1.</b>Introduction to the Internet of Things and Embedded Systems (Weeks 1 and 2) 
                             ...
                             <List pl="4">   
                                ...
                                <Text ><b>2.</b>The C Reference Book: The C programming language
                                ...
                                <Text pl={'2'}>
                                    ...
                                    <br></br>&emsp;<ListItem color={'blue.500'} _hover={{color:'cyan.800',textDecoration:'underline'}}>
                                        <Link
